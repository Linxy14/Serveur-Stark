...
if(!((_unit getVariable "restrained") || (_unit getVariable "Civrestrained"))) exitWith {}; //He's not restrained.
...
//LOG
_text = format["%1(%2) a jail %3(%4) pour %5 minute", player getVariable["realname",name player], getPlayerUID player, _unit getVariable["realname",name _unit], getPlayerUID _unit, _time];
[[25,getPlayerUID player, getPlayerUID _unit, _text],"TON_fnc_log",false,false] spawn life_fnc_MP;