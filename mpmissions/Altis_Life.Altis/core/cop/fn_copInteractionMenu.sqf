...
if(!((player distance (getMarkerPos "police_hq_1") < 80) OR  (player distance (getMarkerPos "police_hq_2") < 80) OR (player distance (getMarkerPos "cop_spawn_3") < 80) OR (player distance (getMarkerPos "cop_spawn_5") < 80) OR  (player distance (getMarkerPos "police_hq_1_1") < 80))) then 
{
